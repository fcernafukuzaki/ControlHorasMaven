...
import { getPeriodoFacturacionRango } from '../actions/actionPeriodoFacturacion';
...
class ProyectoForm extends Component {
	...
	componentWillMount() {
		...
		//this.props.getPeriodoFacturacionRango({periodo: "2017/10"});
		this.props.getPeriodoFacturacionRango({anio: "2017", mes:"12"});
	}
	...
	render() {
		...
		*/
		...
		var form = {
			titulo: 'Registrar Horas Proyecto',
			campos: [
				{
					key: 'idProyecto',
					name: 'idProyecto',
		...
		console.log(this.props.periodoListFacturacionRango);
		console.log(this.props.proyectos);
		this.props.periodoListFacturacionRango.map( elemento =>{
			tableHead.push(
				{
					key: elemento,
					//nombre: dateFormat(elemento, "dd/mm/yyyy")
					nombre: moment(elemento, "dd/mm/yyyy")
				}
			)
		})
		...
		return (
			<div>
				...
				<ControlHorasTable tableHead={tableHead} tableBody={this.props.proyectos} filter={this.state.filter} onClick={this.onClick.bind(this)} />
...
function mapStateToProps(state) {
	console.log(state.reducerPeriodoFacturacion);
	return {
		periodoListFacturacionRango : state.reducerPeriodoFacturacion.getListRangoPeriodoFacturacionResponse,
...
export default connect(mapStateToProps, {
	getPeriodoFacturacionRango, 
	getProyecto //, addProyecto , updateProyecto, getTipoProyecto, 
	//getSupervisor, getAnalistaSeguimiento, getAnalistaFabrica, 
	//getProyectoSupervisorSelected, getProyectoAnalistaSeguimientoSelected, getProyectoAnalistaFabricaSelected,
	//addProyectoSupervisor, updateProyectoSupervisor,
	//addProyectoAnalistaSeguimiento, updateProyectoAnalistaSeguimiento,
	//addProyectoAnalistaFabrica, updateProyectoAnalistaFabrica,
	//getLideresCliente, getLiderCliente 
	})(ProyectoForm);