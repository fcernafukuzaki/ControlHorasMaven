...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxPersist = __webpack_require__(77);
	...
	//initialState,
	(0, _redux.applyMiddleware)(_reduxThunk2.default, _reduxLogger2.default), (0, _reduxPersist.autoRehydrate)());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _HomeLayout = __webpack_require__(29);
	...
	var _FooterContainer = __webpack_require__(31);
	...
	var _handlerError = __webpack_require__(33);
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "p",
	              null,
	              "\xA9 2018 Copyright - Francisco Cerna Fukuzaki"
	            )
	          ),
	          _react2.default.createElement(
	            "form",
	            { className: "Search", onSubmit: this.props.handleSubmit },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FooterContainer = function (_Component) {
	  ...
	  _createClass(FooterContainer, [{
	    key: 'render',
	    value: function render() {
	      return (0, _reactDom.createPortal)(this.props.children, document.getElementById('footer'));
	    }
	  }]);
	...
	var NavBar = function (_Component) {
		...
		_createClass(NavBar, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"nav",
					{ className: "navbar navbar-default navbar-expand-lg navbar-light bg-light", role: "navigation" },
					_react2.default.createElement(
						"a",
						{ className: "navbar-brand", href: "#" },
						_react2.default.createElement("img", { src: "favicon.ico", width: "30", height: "30", className: "d-inline-block align-top" }),
						"Control Horas"
					),
					_react2.default.createElement(
						"button",
					...
					_react2.default.createElement(
						"div",
						{ className: "collapse navbar-collapse", id: "navbarPrincipal" },
						_react2.default.createElement(
							"ul",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _regularError = __webpack_require__(34);
	...
	var HandlerError = function (_Component) {
	  _inherits(HandlerError, _Component);
	
	  function HandlerError(props) {
	    _classCallCheck(this, HandlerError);
	
	    var _this = _possibleConstructorReturn(this, (HandlerError.__proto__ || Object.getPrototypeOf(HandlerError)).call(this, props));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isStatePlainEnough = __webpack_require__(80);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _asyncLocalStorage = __webpack_require__(82);
	...
	var _jsonStringifySafe = __webpack_require__(85);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _setImmediate = __webpack_require__(83);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducerEmpleado = __webpack_require__(99);
	
	var _reducerCargo = __webpack_require__(100);
	
	var _reducerPeriodoFacturacion = __webpack_require__(101);
	
	var _reducerProyecto = __webpack_require__(102);
	
	var _reducerLiderCliente = __webpack_require__(103);
	
	var _reducerCliente = __webpack_require__(104);
	
	var rootReducer = (0, _redux.combineReducers)({
		user: _reducer.showUsers,
		reducerPeriodoFacturacion: _reducerPeriodoFacturacion.actionPeriodoFacturacion,
		reducerProyecto: _reducerProyecto.actionProyecto,
		reducerTipoProyecto: _reducer.actionTipoProyecto,
		reducerTipoTarea: _reducer.actionTipoTarea,
		tipoTareaGET: _reducer.getTipoTarea,
		reducerSupervisor: _reducerEmpleado.getSupervisor,
		reducerAnalistaSeguimiento: _reducerEmpleado.getAnalistaSeguimiento,
		reducerAnalistaFabrica: _reducerEmpleado.getAnalistaFabrica,
		reducerCargo: _reducerCargo.actionCargo,
		reducerLiderCliente: _reducerLiderCliente.actionLiderCliente,
		reducerCliente: _reducerCliente.actionCliente
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionTipoProyecto = actionTipoProyecto;
	exports.actionTipoTarea = actionTipoTarea;
	exports.getTipoTarea = getTipoTarea;
	...
	function showUsers() {
	    ...
	    switch (action.type) {
	        case _actionTypes.EMPLEADOS_ALL:
	...
	function actionTipoProyecto() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	    var action = arguments[1];
	
	    switch (action.type) {
	        case _actionTypes.TIPOPROYECTO_GET:
	...
	function actionTipoTarea() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	    var action = arguments[1];
	
	    switch (action.type) {
	        case _actionTypes.TIPOTAREA_GET:
	...
	function getTipoTarea() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialStateTipoTarea;
	    var action = arguments[1];
...
/***/ (function(module, exports) {
	...
	var EMPLEADOS_SAVED = exports.EMPLEADOS_SAVED = 'PRODUCTS_SAVED';
	var EMPLEADOS_ALL = exports.EMPLEADOS_ALL = 'EMPLEADOS_ALL';
	
	var PERIODOFACTURACION_GET = exports.PERIODOFACTURACION_GET = 'PERIODOFACTURACION_GET';
	var PERIODOFACTURACION_ADD = exports.PERIODOFACTURACION_ADD = 'PERIODOFACTURACION_ADD';
	var PERIODOFACTURACION_UPDATE = exports.PERIODOFACTURACION_UPDATE = 'PERIODOFACTURACION_UPDATE';
	var PERIODOFACTURACION_RANGO_GET = exports.PERIODOFACTURACION_RANGO_GET = 'PERIODOFACTURACION_RANGO_GET';
	
	var PROYECTO_GET = exports.PROYECTO_GET = 'PROYECTO_GET';
	var PROYECTO_ADD = exports.PROYECTO_ADD = 'PROYECTO_ADD';
	var PROYECTO_UPDATE = exports.PROYECTO_UPDATE = 'PROYECTO_UPDATE';
	
	var TIPOPROYECTO_GET = exports.TIPOPROYECTO_GET = 'TIPOPROYECTO_GET';
	
	var TIPOTAREA_GET = exports.TIPOTAREA_GET = 'TIPOTAREA_GET';
	
	var CARGO_GET = exports.CARGO_GET = 'CARGO_GET';
	var CARGO_ADD = exports.CARGO_ADD = 'CARGO_ADD';
	var CARGO_UPDATE = exports.CARGO_UPDATE = 'CARGO_UPDATE';
	
	var EMPLEADO_SUPERVISOR_GET = exports.EMPLEADO_SUPERVISOR_GET = 'EMPLEADO_SUPERVISOR_GET';
	var EMPLEADO_ANALISTA_SEGUIMIENTO_GET = exports.EMPLEADO_ANALISTA_SEGUIMIENTO_GET = 'EMPLEADO_ANALISTA_SEGUIMIENTO_GET';
	var EMPLEADO_ANALISTA_FABRICA_GET = exports.EMPLEADO_ANALISTA_FABRICA_GET = 'EMPLEADO_ANALISTA_FABRICA_GET';
	var PROYECTO_SUPERVISOR_SELECTED_GET = exports.PROYECTO_SUPERVISOR_SELECTED_GET = 'PROYECTO_SUPERVISOR_SELECTED_GET';
	var PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_GET = exports.PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_GET = 'PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_GET';
	var PROYECTO_ANALISTA_FABRICA_SELECTED_GET = exports.PROYECTO_ANALISTA_FABRICA_SELECTED_GET = 'PROYECTO_ANALISTA_FABRICA_SELECTED_GET';
	var PROYECTO_SUPERVISOR_SELECTED_ADD = exports.PROYECTO_SUPERVISOR_SELECTED_ADD = 'PROYECTO_SUPERVISOR_SELECTED_ADD';
	var PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_ADD = exports.PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_ADD = 'PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_ADD';
	var PROYECTO_ANALISTA_FABRICA_SELECTED_ADD = exports.PROYECTO_ANALISTA_FABRICA_SELECTED_ADD = 'PROYECTO_ANALISTA_FABRICA_SELECTED_ADD';
	
	var LIDERCLIENTE_GET = exports.LIDERCLIENTE_GET = 'LIDERCLIENTE_GET';
	var LIDERCLIENTE_ADD = exports.LIDERCLIENTE_ADD = 'LIDERCLIENTE_ADD';
	var LIDERCLIENTE_UPDATE = exports.LIDERCLIENTE_UPDATE = 'LIDERCLIENTE_UPDATE';
	
	var CLIENTE_GET = exports.CLIENTE_GET = 'CLIENTE_GET';
	var CLIENTE_ADD = exports.CLIENTE_ADD = 'CLIENTE_ADD';
	var CLIENTE_UPDATE = exports.CLIENTE_UPDATE = 'CLIENTE_UPDATE';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.getAnalistaSeguimiento = getAnalistaSeguimiento;
	exports.getAnalistaFabrica = getAnalistaFabrica;
	
	var _actionTypes = __webpack_require__(98);
	
	var initialStateEmpleado = {
		...
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialStateEmpleado;
		var action = arguments[1];
	
		switch (action.type) {
			case _actionTypes.EMPLEADO_SUPERVISOR_GET:
	...
	function getAnalistaSeguimiento() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialStateEmpleado;
		var action = arguments[1];
	
		switch (action.type) {
			case _actionTypes.EMPLEADO_ANALISTA_SEGUIMIENTO_GET:
	...
	function getAnalistaFabrica() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialStateEmpleado;
		var action = arguments[1];
	
		switch (action.type) {
			case _actionTypes.EMPLEADO_ANALISTA_FABRICA_GET:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionCargo = actionCargo;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionPeriodoFacturacion = actionPeriodoFacturacion;
	...
	function actionPeriodoFacturacion() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
		var action = arguments[1];
	
		switch (action.type) {
			case _actionTypes.PERIODOFACTURACION_GET:
				return Object.assign({}, state, { getListPeriodoFacturacionResponse: action.payload });
			case _actionTypes.PERIODOFACTURACION_ADD:
				return Object.assign({}, state, { getPeriodoFacturacionResponse: action.payload });
			case _actionTypes.PERIODOFACTURACION_UPDATE:
				return Object.assign({}, state, { getPeriodoFacturacionResponse: action.payload });
			case _actionTypes.PERIODOFACTURACION_RANGO_GET:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionProyecto = actionProyecto;
	...
	function actionProyecto() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
		var action = arguments[1];
	
		switch (action.type) {
			case _actionTypes.PROYECTO_GET:
				return Object.assign({}, state, { getListProyectoResponse: action.payload });
			case _actionTypes.PROYECTO_ADD:
				return Object.assign({}, state, { getProyectoResponse: action.payload });
			case _actionTypes.PROYECTO_UPDATE:
				return Object.assign({}, state, { getProyectoResponse: action.payload });
			case _actionTypes.PROYECTO_SUPERVISOR_SELECTED_GET:
				return Object.assign({}, state, { getListSupervisorResponse: action.payload });
			case _actionTypes.PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_GET:
				return Object.assign({}, state, { getListAnalistaSeguimientoResponse: action.payload });
			case _actionTypes.PROYECTO_ANALISTA_FABRICA_SELECTED_GET:
				return Object.assign({}, state, { getListAnalistaFabricaResponse: action.payload });
			case _actionTypes.PROYECTO_SUPERVISOR_SELECTED_ADD:
				return Object.assign({}, state, { getSupervisorResponse: action.payload });
			case _actionTypes.PROYECTO_ANALISTA_SEGUIMIENTO_SELECTED_ADD:
				return Object.assign({}, state, { getAnalistaSeguimientoResponse: action.payload });
			case _actionTypes.PROYECTO_ANALISTA_FABRICA_SELECTED_ADD:
				return Object.assign({}, state, { getAnalistaFabricaResponse: action.payload });
			default:
				return state;
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionLiderCliente = actionLiderCliente;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionCliente = actionCliente;
